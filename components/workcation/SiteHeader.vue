  ...
  <header class="bg-gray-900 sm:flex sm:items-center sm:justify-between xl:bg-white">
    ...
    >
      <div class="hidden xl:block xl:relative xl:max-w-xs xl:w-full">
        ...
        <input
          class="block w-full py-2 pl-10 pr-4 text-gray-900 bg-gray-200 border border-transparent rounded-lg focus:outline-none focus:bg-white focus:border-gray-300"
      ...
      <div class="sm:flex sm:items-center">
        <div class="px-2 pt-2 pb-5 border-b border-gray-800 sm:flex sm:border-b-0 sm:py-0 sm:px-0">
          <a
            href="#"
            class="block px-3 py-1 font-semibold text-white rounded hover:bg-gray-800 sm:text-sm sm:px-2 xl:text-gray-900 xl:hover:bg-gray-200"
          >List your property</a>
          <a
            href="#"
            class="block px-3 py-1 mt-1 font-semibold text-white rounded hover:bg-gray-800 sm:mt-0 sm:text-sm sm:px-2 sm:ml-2 xl:text-gray-900 xl:hover:bg-gray-200"
          >Trips</a>
          <a
            href="#"
            class="block px-3 py-1 mt-1 font-semibold text-white rounded hover:bg-gray-800 sm:mt-0 sm:text-sm sm:px-2 sm:ml-2 xl:text-gray-900 xl:hover:bg-gray-200"
        ...
        <div class="relative px-5 py-5 sm:py-0 sm:ml-4 sm:px-0">
          <div class="flex items-center sm:hidden">
            <img
              class="object-cover w-10 h-10 border-2 border-gray-600 rounded-full"
          ...
          <Dropdown class="hidden sm:block">
            <template #trigger="{ hasFocus, isOpen }">
              <span
                class="block w-8 h-8 overflow-hidden border-2 rounded-full"
            ...
            <template #dropdown>
              <div class="w-48 py-2 mt-3 bg-white rounded-lg shadow-xl xl:border">
                ...
                <a
                  href="#support"
                  class="block px-4 py-2 mt-0 text-gray-800 hover:text-white hover:bg-indigo-500"
                >Support</a>
                <a
                  href="#sign-out"
                  class="block px-4 py-2 mt-0 text-gray-800 hover:text-white hover:bg-indigo-500"
